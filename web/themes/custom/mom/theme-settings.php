 ...
 */
function mom_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['mom_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('mom sample setting'),
  '#default_value' => theme_get_setting('mom_example'),
